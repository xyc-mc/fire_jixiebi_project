...
from .elite_arm_servo import EliteArmServo
from .elite_arm_set_tcp import EliteArmSetTCP


class EliteDriver(Node, EliteArmKinematics, EliteArmMove, EliteArmSetIO, EliteStatePublisher, EliteArmTrajectoryAction, EliteArmServo, EliteArmSetTCP):
    ...
    def __init__(self) -> None:
        ...
        EliteArmServo.__init__(self)
        EliteArmSetTCP.__init__(self)
